angular.module('openshiftCommonUI').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('src/components/delete-project/delete-project-modal.html',
    ...
    "      <button ng-disabled=\"typeNameToConfirm && confirmName !== project.metadata.name && confirmName !== (project | displayName : false)\" class=\"btn btn-lg btn-danger\" type=\"submit\" ng-click=\"delete()\" translategrun>Delete</button>\n" +
